odoo.define('web.IndexContent', function (require) {
"use strict";
...
var Main = Widget.extend({
        ...
        attach: function (el, options) {
            ...
            this.content = new Content(el, this.menu_data);
            this.content.appendTo($('.o_IndexContent'));
            this.content.attach($('.o_IndexContent'), options);
        },
        detach: function () {
            this.$el.detach();
        },
...
var Related = Widget.extend({
    ...
    render_related:function(){
        var data = "";
        var $info = $(QWeb.render('index_related_info', {
            'data': data
        }));
    ...
    search:function(){
        ...
        new Model('hr.employee')
            ...
            .then(function (result) {
                var $info = $(QWeb.render('index_related_user_search', {
                'users': result,
...
var Content = Widget.extend({
    ...
    render_title: function(){
        ...
        var $info = $(QWeb.render('index_content_title', {
            'username': username
        }));
        $info.appendTo('.o_content_title');
    },
    render_dashboard: function(parent){
        var menus=this.menu_data;
        ...
        var $info = $(QWeb.render('index_content_dashboard', {
            "check_sets": check,
        ...
        new Model('dtdream_notice.dtdream_notice')
            ...
            .then(function (result) {
                    if (result.length != 0){
                        ...
                        var $info = $(QWeb.render('index_content_notice', {
                            'notices': result
                        }));
    ...
    render_event: function(){
        var $info = $(QWeb.render('index_content_event', {}));
...
//                    .call("get_all_affairs", [menu_data,currentPage],{},null)
                    ...
                    .then(function (data) {
                        ...
                        var $info = $(QWeb.render('index_content_event_affairs', {
                            'affairs': affairs,
...
//                    .call("get_all_applies", [menu_data,currentPage],{},null)
                    ...
                    .then(function (data) {
                        ...
                        var $info = $(QWeb.render('index_content_event_applies', {
                            'applies': applies,
