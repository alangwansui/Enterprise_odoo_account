...
var DebugManager = Widget.extend({
    ...
    start: function () {
        ...
        this.$dropdowns = this.$(".o_debug_dropdowns");
...
DebugManager.include({
    ...
    update: function (tag, descriptor) {
        ...
        return this._super().then(function () {
            this.$dropdowns.append(QWeb.render('WebClient.DebugManager.Action', {
                manager: this,
                action: this._action
            }));
        }.bind(this));
...
DebugManager.include({
    ...
    update: function (tag, descriptor, widget) {
        ...
        return this._super(tag, descriptor).then(function () {
            this.$dropdowns.append(QWeb.render('WebClient.DebugManager.View', {
                manager: this,
                action: this._action,
                view: this._active_view,
                can_edit: this._can_edit_views,
                searchview: this._view_manager
                             && this._view_manager.searchview
            }));
        }.bind(this));
    },
    ...
    WebClient.include({
        show_common: function() {
            ...
            return this._super().then(function () {
                ...
                var started = self.debug_manager.appendTo(self.$el);
                ...
                self.action_manager.push_action = function(widget, descr) {
                    return $.when(push_action.apply(self.action_manager, arguments), started).then(function() {
