...
# 办事处、系统部主管
class dtdream_office_system_line(models.Model):
    _name = "dtdream.office.system.line"

    office_system_line_id = fields.Many2one('dtdream.project.authorize.config')
...
class dtdream_project_authorize_config(models.Model):
    ...
    office_system_line =   fields.One2many('dtdream.office.system.line','office_system_line_id', string='办事处/系统部审批配置')
    ...
    approver = fields.Many2one('hr.employee', string="审批同意")
