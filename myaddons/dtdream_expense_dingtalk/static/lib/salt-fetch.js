...
var nattyStorage = __webpack_require__(3);
var nattyFetchPluginDingTalk = __webpack_require__(4);
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		define("nattyFetchPluginDingTalk", ["natty-fetch"], factory);
	else if(typeof exports === 'object')
		exports["nattyFetchPluginDingTalk"] = factory(require("natty-fetch"));
	else
		root["nattyFetchPluginDingTalk"] = factory(root["nattyFetch"]);
...
var nattyFetch = __webpack_require__(1);
var _nattyFetch$_util = nattyFetch._util;
var appendQueryString = _nattyFetch$_util.appendQueryString;
var extend = _nattyFetch$_util.extend;
var param = _nattyFetch$_util.param;

var lwp = function lwp(apiInstance) {
    // 只有get/post才使用lwp
...
// 所有钉钉的插件都放这里
nattyFetch.plugin.dingtalk = dingtalkPlugin;
